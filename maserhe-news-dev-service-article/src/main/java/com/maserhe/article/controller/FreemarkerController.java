...
import com.maserhe.Spouse;
import com.maserhe.entity.ArticleDo;
import com.maserhe.entity.Stu;
...
public class FreemarkerController {
    ...
    private List<ArticleDo> getArticles() {
        ArticleDo article1 = new ArticleDo();
        article1.setId("1001");
        article1.setTitle("今天天气不错");

        ArticleDo article2 = new ArticleDo();
        article2.setId("1002");
        article2.setTitle("今天下雨了");

        ArticleDo article3 = new ArticleDo();
        article3.setId("1003");

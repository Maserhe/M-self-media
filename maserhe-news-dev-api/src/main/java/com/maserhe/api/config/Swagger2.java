...
public class Swagger2 {
    ...
    public Docket createRestApi() {
        Predicate<RequestHandler> adminPredicate = RequestHandlerSelectors.basePackage("com.maserhe.user.controller");

        /*
        Predicate<RequestHandler> articlePredicate = RequestHandlerSelectors.basePackage("com.maserhe.api.controller.user");
        Predicate<RequestHandler> userPredicate = RequestHandlerSelectors.basePackage("com.maserhe.api.controller.user");
        ...
        return new Docket(DocumentationType.SWAGGER_2)  // 指定api类型为swagger2
                ...
                .select()
                .apis(Predicates.or(adminPredicate))
